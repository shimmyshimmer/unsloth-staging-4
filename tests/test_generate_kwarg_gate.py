"""GPU-free unit test for the logits_to_keep generate-kwarg gate added to
unsloth/models/vision.py (_unsloth_generate_accepts_kwarg). Mirrors transformers
GenerationMixin._validate_model_kwargs so the injection never triggers
'ValueError: The following model_kwargs are not used by the model: [...]'.

AST-extracts the real helper from vision.py (no unsloth/CUDA import needed), the
same technique as tests/saving/test_is_gpt_oss_detection.py.
"""
