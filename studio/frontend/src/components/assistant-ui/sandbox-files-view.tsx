...
function SandboxFileRow({
  ...
  // bytes, then hand them to the same save path the rest of the app uses (which
  // is a native save dialog in the desktop build).
...
/**
 * "Files created" row under a tool card.
 *
 * Without this the only trace of a file a tool wrote was the model mentioning
 * it in prose, and the only way to get at it was to go looking through the
 * filesystem by hand.
 */
