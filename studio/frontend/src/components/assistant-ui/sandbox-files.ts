 ...
 *
 * The backend appends `__FILES__` before `__IMAGES__` precisely because older
 * clients slice from `__IMAGES__` to the end of the string, so this marker has
 * to sit in front of it. Unparseable payloads leave the text untouched.
 */
