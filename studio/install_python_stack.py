...
# _uv_safe_path() lives in backend.utils.uv_path_safety so utils.mlx_repair can
# share the exact same space-free-path logic for its UV_OVERRIDE handoff. It is
# imported as _uv_safe_path at the top of this module.
...
# Route through _uv_safe_path: uv truncates UV_OVERRIDE at the first space too,
# so a repo cloned under e.g. ".../Open Source/unsloth" would otherwise break
# every uv install on macOS arm64 (https://github.com/unslothai/unsloth/issues/6503).
