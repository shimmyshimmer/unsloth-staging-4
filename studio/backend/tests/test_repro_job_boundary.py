# Where exactly does the Windows orphan guarantee hold, and where does it stop?
#
# Studio binds children to the parent with a Job Object carrying
# JOB_OBJECT_LIMIT_KILL_ON_JOB_CLOSE (utils/process_lifetime.py:88). The
# desktop updater clears that flag before launching the installer
# (src-tauri/src/windows_job.rs:103) and nothing ever restores it.
#
# These tests pin both sides of that boundary with real processes.
