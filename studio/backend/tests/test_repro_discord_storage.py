# Regression tests for the Discord report about Unsloth Studio file locations.
#
# These started life asserting the buggy behaviour so it could be reproduced on
# Windows / macOS / Linux runners; they now assert the fixed behaviour and are
