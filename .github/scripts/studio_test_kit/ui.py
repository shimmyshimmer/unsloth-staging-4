...
async def set_pill(
    ...
    btn = sp.page.locator(f'form:has(textarea) button:has-text("{label}")').first
...
async def wait_for_image(
    ...
    mime_prefixes: tuple[str, ...] = ("data:image/png", "data:image/jpeg", "data:image/webp"),
) -> str:
